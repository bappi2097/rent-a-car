...
@section('content')
    ...
    <div class="bg-white p-20 col-12 m-t-30">
        <form action="{{ route('admin.setting.slider.update', $slider->id) }}" method="POST"
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <img id="user-image" style="width: 100%; height: 100%;" src="{{ asset($slider->image) }}"
                ...
                <div class="form-group">
                    ...
                    <select name="category" id="category" class="form-control">
                        ...
                        <option value="home" @if ($slider->category == 'home') selected @endif> Home</option>
                        <option value="car-operator" @if ($slider->category == 'car-operator') selected @endif>Car
                            Operator</option>
                    </select>
                    @error('category')
                        <span class="text-red">{{ $message }}</span>
