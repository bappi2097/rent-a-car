...
@section('content')
    <a href="{{ route('admin.car-trip-category.create') }}" class="btn btn-primary">Add Data</a>
    <div class="col-12 mt-3 bg-white rounded p-3">
        <div class="table-responsive">
            <table class="table table-striped m-b-0" id="myTable">
                ...
                <tbody>
                    @foreach ($carTripCategories as $index => $carTripCategory)
                        <tr>
                            <td>{{ $index + 1 }}</td>
                            <td>{{ $carTripCategory->name }}</td>
                            <td class="with-btn" nowrap="">
                                <a href="{{ route('admin.car-trip-category.edit', $carTripCategory->id) }}"
                                ...
                                <form id="language{{ $index }}"
                                    action="{{ route('admin.car-trip-category.destroy', $carTripCategory->id) }}"
