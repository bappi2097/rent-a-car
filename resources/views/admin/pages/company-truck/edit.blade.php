...
@section('content')
    <a href="{{ route('admin.user.company.car.index', $company->id) }}" class="btn btn-white"> &lt; Back</a>
    <div class="bg-white p-20 col-12 m-t-30">
        <form action="{{ route('admin.user.company.car.update', ['company' => $company->id, 'car' => $car->id]) }}"
