...
@section('content')
    ...
    <div class="container h-5 mb-5 bg-white text-rtl">
        <div class="p-5">
            <p>
                Rent A Car is a private company limited by shares operates in the name of
                “Rent A Car Limited” (hereinafter referred to as “TL”) with its Head
                Office at Saudi, Arabia. TL has formed directly or through its
                subsidiaries partnership agreements with privileged groups of car
            ...
            <div>
                ...
                prior creation of a User Account (rent-a-car account) which is accessible
                through free installation of the Application by the User through
                downloading the Application or visiting the website of
                https://www.rent-a-car.com . ARTICLE 2 – BENEFICIARIES OF ACQUIRED RIGHTS
            </div>
            <div class="mt-3">
